...
public class Hit {
    ...
    public Hit(String largeImageURL, Integer id, String tags, String webformatURL, String previewURL) {
    ...
    public Hit(String previewURL, String title) {
        this.previewURL = previewURL;
        this.title = title;
    }

    public Hit(String largeImageURL){
        this.largeImageURL = largeImageURL;
    }
